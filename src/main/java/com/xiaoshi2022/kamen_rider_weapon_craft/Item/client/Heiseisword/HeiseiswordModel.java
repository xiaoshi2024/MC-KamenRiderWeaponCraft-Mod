...
public class HeiseiswordModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public HeiseiswordModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public HeiseiswordModel<T> withAltModel(ResourceLocation altPath) {
        return (HeiseiswordModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/heiseisword.geo.json"));
    }
     ...
     */
    @Override
    public HeiseiswordModel<T> withAltAnimations(ResourceLocation altPath) {
        return (HeiseiswordModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/heiseisword.animation.json"));
    }
     ...
     */
    @Override
    public HeiseiswordModel<T> withAltTexture(ResourceLocation altPath) {
        return (HeiseiswordModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/heiseisword.png"));
    }
}
