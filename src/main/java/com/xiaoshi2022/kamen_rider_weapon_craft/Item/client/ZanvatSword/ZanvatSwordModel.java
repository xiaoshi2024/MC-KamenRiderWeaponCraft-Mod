...
public class ZanvatSwordModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public ZanvatSwordModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public ZanvatSwordModel<T> withAltModel(ResourceLocation altPath) {
        return (ZanvatSwordModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/zanvat_sword.geo.json"));
    }
     ...
     */
    @Override
    public ZanvatSwordModel<T> withAltAnimations(ResourceLocation altPath) {
        return (ZanvatSwordModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/zanvat_sword.animation.json"));
    }
     ...
     */
    @Override
    public ZanvatSwordModel<T> withAltTexture(ResourceLocation altPath) {
        return (ZanvatSwordModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/zanvat_sword.png"));
    }
}
