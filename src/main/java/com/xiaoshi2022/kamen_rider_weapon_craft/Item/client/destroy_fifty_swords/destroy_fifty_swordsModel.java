...
public class destroy_fifty_swordsModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
     ...
     * }</pre>
     */
    public destroy_fifty_swordsModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public destroy_fifty_swordsModel<T> withAltModel(ResourceLocation altPath) {
        return (destroy_fifty_swordsModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/destroy_fifty_swords.geo.json"));
    }
     ...
     */
    @Override
    public destroy_fifty_swordsModel<T> withAltAnimations(ResourceLocation altPath) {
        return (destroy_fifty_swordsModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/destroy_fifty_swords.animation.json"));
    }
     ...
     */
    @Override
    public destroy_fifty_swordsModel<T> withAltTexture(ResourceLocation altPath) {
        return (destroy_fifty_swordsModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/destroy_fifty_swords.png"));
    }
}
