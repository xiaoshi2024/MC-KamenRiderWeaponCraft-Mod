...
public class gavvwhipirModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public gavvwhipirModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public gavvwhipirModel<T> withAltModel(ResourceLocation altPath) {
        return (gavvwhipirModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/gavvwhipir.geo.json"));
    }
     ...
     */
    @Override
    public gavvwhipirModel<T> withAltAnimations(ResourceLocation altPath) {
        return (gavvwhipirModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/gavvwhipir.animation.json"));
    }
     ...
     */
    @Override
    public gavvwhipirModel<T> withAltTexture(ResourceLocation altPath) {
        return (gavvwhipirModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/gavvwhipir.png"));
    }
}