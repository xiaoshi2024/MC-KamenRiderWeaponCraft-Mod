...
public class BanaSpearModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public BanaSpearModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public BanaSpearModel<T> withAltModel(ResourceLocation altPath) {
        return (BanaSpearModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/bana_spear.geo.json"));
    }
     ...
     */
    @Override
    public BanaSpearModel<T> withAltAnimations(ResourceLocation altPath) {
        return (BanaSpearModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/bana_spear.animation.json"));
    }
     ...
     */
    @Override
    public BanaSpearModel<T> withAltTexture(ResourceLocation altPath) {
        return (BanaSpearModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/bana_spear.png"));
    }
}