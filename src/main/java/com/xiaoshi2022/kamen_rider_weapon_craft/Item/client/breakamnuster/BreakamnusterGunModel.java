...
public class BreakamnusterGunModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public BreakamnusterGunModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public BreakamnusterGunModel<T> withAltModel(ResourceLocation altPath) {
        return (BreakamnusterGunModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/breakam_buster.geo.json"));
    }
     ...
     */
    @Override
    public BreakamnusterGunModel<T> withAltAnimations(ResourceLocation altPath) {
        return (BreakamnusterGunModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/breakam_buster.animation.json"));
    }
     ...
     */
    @Override
    public BreakamnusterGunModel<T> withAltTexture(ResourceLocation altPath) {
        return (BreakamnusterGunModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/breakam_buster.png"));
    }
}