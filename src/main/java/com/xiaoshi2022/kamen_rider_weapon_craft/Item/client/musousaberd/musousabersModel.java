...
public class musousabersModel <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public musousabersModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public musousabersModel<T> withAltModel(ResourceLocation altPath) {
        return (musousabersModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"geo/item/musou_saber.geo.json"));
    }
     ...
     */
    @Override
    public musousabersModel<T> withAltAnimations(ResourceLocation altPath) {
        return (musousabersModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"animations/item/musou_saber.animation.json"));
    }
     ...
     */
    @Override
    public musousabersModel<T> withAltTexture(ResourceLocation altPath) {
        return (musousabersModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_weapon_craft.MOD_ID,"textures/item/musou_saber.png"));
    }
}