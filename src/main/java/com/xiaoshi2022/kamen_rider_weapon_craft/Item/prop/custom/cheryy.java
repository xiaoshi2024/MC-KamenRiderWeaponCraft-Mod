...
import com.xiaoshi2022.kamen_rider_weapon_craft.Item.prop.client.cheryy.cheryyRenderer;
...
public class cheryy extends Item implements GeoItem {
    ...
    public cheryy(net.minecraft.world.item.Item.Properties properties) {
        super(properties);
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private cheryyRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new cheryyRenderer();
    ...
    private void playSound(Level level, Player player, BlockPos pos) {
        if (level instanceof ServerLevel serverLevel) {
            serverLevel.playSound(null, pos, ModSounds.CHERYYENERGY.get(), SoundSource.PLAYERS, 1, 1);
        }
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "start", 20, state -> PlayState.STOP)
                ...
                .setSoundKeyframeHandler(state -> {
                    ...
                    if (player != null)
                        player.playSound(ModSounds.CHERYYENERGY.get(), 1, 1);
                }));
    }
