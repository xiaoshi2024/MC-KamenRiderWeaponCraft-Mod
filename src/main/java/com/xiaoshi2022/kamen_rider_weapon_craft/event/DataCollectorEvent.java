...
import com.xiaoshi2022.kamen_rider_weapon_craft.villagers.ModProfessionPoiTypeTags;
...
public class DataCollectorEvent {
    ...
    public static void DataCollect(GatherDataEvent gatherDataEvent) {
        ...
        dataGenerator.addProvider(
                ...
                new ModProfessionPoiTypeTags(packOutput, providerCompletableFuture, kamen_rider_weapon_craft.MOD_ID, existingFileHelper)
        );
    }
}
