...
public class OpenLockseedGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public OpenLockseedGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(ModMenus.OPEN_LOCKSEED_GUI.get(), id);
    ...
    public static void open(Player player) {
        // 创建菜单实例并打开屏幕
        OpenLockseedGuiScreen screen = new OpenLockseedGuiScreen(player);
